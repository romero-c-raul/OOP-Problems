...
- When attempting to sort an array of various lengths, we are surprised to see 
  ...
  the various lengths can be properly sorted and line 62 produces the expected output.
=end
class Length
...
puts Length.new(1, :km) != Length.new(1, :nmi) # "==" method also allows you to use
# "!=" method without it being explicitly defined

# If you include Comparable you can remove the ==, >, <, >=, <= methods